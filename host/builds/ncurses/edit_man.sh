...
(*.[0-9]*)
	...
	if test ! -f /home/alan/optware/host/builds/ncurses/man_alias.sed ; then
cat >>/home/alan/optware/host/builds/ncurses/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
s,@TSET@,tset,g
CF_EOF2
		echo "...made /home/alan/optware/host/builds/ncurses/man_alias.sed"
	fi
	...
	aliases=`sed -f $top_srcdir/man/manlinks.sed $inalias |sed -f /home/alan/optware/host/builds/ncurses/man_alias.sed | sort -u; test $inalias = $nCurses && echo curses`
	cf_target=`grep "^$cf_source" /home/alan/optware/host/builds/ncurses/man/man_db.renames | mawk '{print $2}'`
	...
	sed	-f /home/alan/optware/host/builds/ncurses/man_alias.sed \
		< $i | sed -f /home/alan/optware/host/builds/ncurses/edit_man.sed >$TMP
