...
# You must replace "libffi" and "LIBFFI" with the lower case name and
...
.PHONY: libffi-source libffi-unpack libffi libffi-stage libffi-ipk libffi-clean libffi-dirclean libffi-check
