...
$(ENDOR_ATTERO_IPK): $(ENDOR_ATTERO_BUILD_DIR)/.built
	...
	install -m 755 $(ENDOR_ATTERO_SOURCE_DIR)/cat-supervisor-pfv				$(ENDOR_ATTERO_IPK_DIR)/opt/bin/cat-supervisor-pfv
	...
	install -m 755 $(ENDOR_ATTERO_BUILD_DIR)/Endor/Instrument/Calnex.Endor.Instrument.Controller/Shell/get_endor_revision.sh  $(ENDOR_ATTERO_IPK_DIR)/opt/lib/endor/get_endor_revision.sh
	...
	install -m 755 $(ENDOR_ATTERO_BUILD_DIR)/Endor/Web/WebApp/Shell/update_software.sh                                        $(ENDOR_ATTERO_IPK_DIR)/opt/lib/endor/update_software.sh
	install -m 755 $(ENDOR_ATTERO_BUILD_DIR)/Endor/Web/WebApp/Shell/update_software_worker.sh                                 $(ENDOR_ATTERO_IPK_DIR)/opt/lib/endor/update_software_worker.sh
