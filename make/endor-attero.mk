...
$(ENDOR_ATTERO_IPK): $(ENDOR_ATTERO_BUILD_DIR)/.built-attero
	...
	install -m 755 $(ENDOR_ATTERO_BUILD_DIR)/Endor/Web/WebApp/Shell/Shell/set_time.sh                                         $(ENDOR_ATTERO_IPK_DIR)/opt/lib/endor/set_time.sh
	install -m 755 $(ENDOR_ATTERO_BUILD_DIR)/Endor/Web/WebApp/Shell/Shell/set_date.sh                                         $(ENDOR_ATTERO_IPK_DIR)/opt/lib/endor/set_date.sh
