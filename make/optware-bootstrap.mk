...
ifneq (OPTWARE-BOOTSTRAP_REAL_OPT_DIR,)
	...
	echo "cd bootstrap && sh bootstrap.sh && mv S00SystemConfiguration /etc/init.d && mv S00SystemLoading /etc/init.d && mv S90fix-interfaces /opt/etc/init.d && mv loading_server /sbin &&  mv loading_server.py /sbin && mv ip_fallback /sbin && cd .. && rm -r bootstrap && exit 0" >>$@
