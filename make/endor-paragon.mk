...
#
ifdef ENDOR_PARAGON_GIT_REFERENCE_ROOT
ENDOR_PARAGON_SPRINGBANK_GIT_REFERENCE=--reference $(ENDOR_PARAGON_GIT_REFERENCE_ROOT)/Springbank
ENDOR_PARAGON_CAT_GIT_REFERENCE=--reference $(ENDOR_PARAGON_GIT_REFERENCE_ROOT)/CAT
ENDOR_PARAGON_DATASTORAGE_GIT_REFERENCE=--reference $(ENDOR_PARAGON_GIT_REFERENCE_ROOT)/DataStorage
ENDOR_PARAGON_DOCUMENTATION_GIT_REFERENCE=--reference $(ENDOR_PARAGON_GIT_REFERENCE_ROOT)/EndorDocumentation
endif
...
ENDOR_PARAGON_GIT_REFERENCE_ROOT?=$(ENDOR_PARAGON_COMMON_SOURCE_REPOSITORY)
